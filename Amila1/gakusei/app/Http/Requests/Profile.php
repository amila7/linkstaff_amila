...
class Profile extends FormRequest
{
    ...
    public function rules()
    {
        // return [
        //     'MaSo' => ['required',
        //                 'unique:sinhviens,MaSo',
        //                 'regex:/^(0|1|2)\d{2}([0-9])\d{1}([0-9][0-9]|[1-9]0[4|5|6])\d{6}$/'],
        //     'HoTen' => 'required',
        //     'NgaySinh' => 'required|before:'.Carbon::now()->subYears(18),
    ...
    public function messages()
    {
        ...
        //     'NgaySinh.before' => '18歳以上入力可',
        //     'SoDT.required' => 'So DT can not be empty',
        //     'SoDT.digits' => 'so dien thoai phai la 11 chu so',
        //     'email.unique' => 'email '.$this->email.' exit',
