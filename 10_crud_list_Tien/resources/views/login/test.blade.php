                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-control">
                            ...
                            <strong>合否</strong><br>
                            <input type="radio" name="first_interv_result" id="option22" value="1"
                                {{ old('first_interv_result') === 1 ? 'checked' : '' }}>
                            <label for="option22">
                                合格
                            </label><br>
                            <input type="radio" name="first_interv_result" id="option33" value="2"
                                {{ old('first_interv_result') === 2 ? 'checked' : '' }}>
                            <label for="option33">
                                不合格
                            </label>
                            <br>
                            <input type="radio" name="first_interv_result" id="option11" value="0"
